...
assignment. We implemented a simple virtual machine in C, which emulated a UM.
This UM reads in a .um file of instructions and executes these machine 
...
memory into registers (this UM has 8). The unpacking and execution of the 
instructions in done in instructions.c. These registers execute the instructions.
